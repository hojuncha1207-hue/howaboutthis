...
const mealKitData = [
    {
        ...
        "ingredients": [
            { "name": "된장 2큰술", "request": "" },
            { "name": "두부 1/2모", "request": "찌개용" },
            { "name": "애호박 1/3개", "request": "" },
            { "name": "양파 1/4개", "request": "" },
            { "name": "감자 1/2개", "request": "" },
            { "name": "대파 1/4대", "request": "어슷썰기" },
            { "name": "청양고추 1개", "request": "" },
            { "name": "국물용 멸치 한 줌", "request": "" }
        ]
    },
    {
        "id": "mk81",
        ...
        "ingredients": [
            { "name": "돼지고기 앞다리살 300g", "request": "제육용" },
            { "name": "고추장 2큰술", "request": "" },
            { "name": "양파 1/2개", "request": "" },
            { "name": "대파 1/2대", "request": "" },
            { "name": "깻잎 10장", "request": "" },
            { "name": "다진 마늘 1큰술", "request": "" },
            { "name": "다진 생강 1작은술", "request": "" },
            { "name": "참기름 1큰술", "request": "" }
        ]
    },
    {
        "id": "mk82",
        ...
        "ingredients": [
            { "name": "당면 100g", "request": "" },
            { "name": "소고기 잡채용 100g", "request": "채썰기" },
            { "name": "시금치 1/2단", "request": "" },
            { "name": "당근 1/3개", "request": "채썰기" },
            { "name": "양파 1/2개", "request": "채썰기" },
            { "name": "표고버섯 3개", "request": "채썰기" },
            { "name": "간장 3큰술", "request": "" },
            { "name": "설탕 1.5큰술", "request": "" },
            { "name": "참기름 1큰술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "오징어 1/2마리", "request": "손질" },
            { "name": "칵테일 새우 한 줌", "request": "" },
            { "name": "쪽파 1/2단", "request": "" },
            { "name": "부침가루 1컵", "request": "" },
            { "name": "계란 1개", "request": "" },
            { "name": "식용유", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "소고기 불고기용 300g", "request": "" },
            { "name": "배 1/4개", "request": "강판에 갈기" },
            { "name": "양파 1/2개", "request": "채썰기" },
            { "name": "대파 1/2대", "request": "어슷썰기" },
            { "name": "표고버섯 2개", "request": "" },
            { "name": "간장 4큰술", "request": "" },
            { "name": "설탕 2큰술", "request": "" },
            { "name": "다진 마늘 1큰술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "닭볶음탕용 닭 1마리", "request": "" },
            { "name": "감자 2개", "request": "" },
            { "name": "당근 1/2개", "request": "" },
            { "name": "양파 1/2개", "request": "" },
            { "name": "대파 1대", "request": "" },
            { "name": "청양고추 2개", "request": "" },
            { "name": "고추장 3큰술", "request": "" },
            { "name": "다진 마늘 1큰술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "고등어 1마리", "request": "손질" },
            { "name": "무 200g", "request": "큼직하게" },
            { "name": "대파 1/2대", "request": "" },
            { "name": "양파 1/2개", "request": "" },
            { "name": "고춧가루 2큰술", "request": "" },
            { "name": "간장 3큰술", "request": "" },
            { "name": "다진 마늘 1큰술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "꽃게 2마리", "request": "탕용 손질" },
            { "name": "무 150g", "request": "" },
            { "name": "애호박 1/3개", "request": "" },
            { "name": "대파 1/2대", "request": "" },
            { "name": "쑥갓 한 줌", "request": "" },
            { "name": "된장 1큰술", "request": "" },
            { "name": "고추장 1큰술", "request": "" },
            { "name": "다진 마늘 1큰술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "감자 3개", "request": "" },
            { "name": "양파 1/4개", "request": "" },
            { "name": "청양고추 1개", "request": "선택사항" },
            { "name": "부침가루 2큰술", "request": "" },
            { "name": "식용유", "request": "" }
        ]
    },
    {
    ...
    },
    {
        ...
        "ingredients": [
            { "name": "밥 1공기", "request": "" },
            { "name": "시금치나물 한 줌", "request": "" },
            { "name": "도라지나물 한 줌", "request": "" },
            { "name": "고사리나물 한 줌", "request": "" },
            { "name": "콩나물무침 한 줌", "request": "" },
            { "name": "소고기 볶음 50g", "request": "" },
            { "name": "계란 1개", "request": "후라이" },
            { "name": "참기름 1큰술", "request": "" },
            { "name": "고추장 1큰술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            ...
            { "name": "국물용 멸치 한 줌", "request": "" },
            { "name": "다시마 1장", "request": "" },
            { "name": "애호박 1/4개", "request": "채썰기" },
            { "name": "당근 약간", "request": "채썰기" },
            { "name": "계란 1개", "request": "지단용" },
            { "name": "신김치 약간", "request": "" },
            { "name": "국간장 1큰술", "request": "" }
        ]
    },
    {
        "id": "mk92",
        ...
        "ingredients": [
            { "name": "돼지등뼈 500g", "request": "핏물 제거" },
            { "name": "삶은 시래기 한 줌", "request": "" },
            { "name": "감자 1개", "request": "" },
            { "name": "들깨가루 2큰술", "request": "" },
            { "name": "된장 1큰술", "request": "" },
            { "name": "고추장 1/2큰술", "request": "" },
            { "name": "다진 마늘 1큰술", "request": "" },
            { "name": "다진 생강 1작은술", "request": "" }
        ]
    },
    {
        ...
        "ingredients": [
            { "name": "떡볶이 떡 300g", "request": "" },
            { "name": "어묵 2장", "request": "" },
            { "name": "양파 1/4개", "request": "" },
            { "name": "대파 1/2대", "request": "" },
            { "name": "삶은 계란 1개", "request": "" },
            { "name": "고추장 3큰술", "request": "" },
            { "name": "설탕 1.5큰술", "request": "" }
        ]
    },
