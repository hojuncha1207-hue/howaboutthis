...
const mealKitData = [
    {
        ...
        "ingredients": ["된장", "두부", "애호박", "양파", "감자", "대파", "청양고추", "멸치"]
    },
    {
        "id": "mk81",
        "name": "제육볶음",
        ...
        "ingredients": ["돼지고기", "고추장", "양파", "대파", "깻잎", "마늘", "생강", "참기름"]
    },
    {
        "id": "mk82",
        "name": "잡채",
        ...
        "ingredients": ["당면", "소고기", "시금치", "당근", "양파", "버섯", "간장", "설탕", "참기름"]
    },
    {
        "id": "mk83",
        "name": "해물파전",
        ...
        "ingredients": ["오징어", "새우", "쪽파", "부침가루", "계란", "식용유"]
    },
    {
        "id": "mk84",
        "name": "소불고기",
        ...
        "ingredients": ["소고기", "배", "양파", "대파", "버섯", "간장", "설탕", "다진 마늘"]
    },
    {
        "id": "mk85",
        "name": "닭볶음탕",
        ...
        "ingredients": ["닭고기", "감자", "당근", "양파", "대파", "고추", "고추장", "다진 마늘"]
    },
    {
        "id": "mk86",
        "name": "고등어조림",
        ...
        "ingredients": ["고등어", "무", "대파", "양파", "고춧가루", "간장", "다진 마늘"]
    },
    {
        "id": "mk87",
        "name": "꽃게탕",
        ...
        "ingredients": ["꽃게", "무", "애호박", "대파", "쑥갓", "된장", "고추장", "다진 마늘"]
    },
    {
        "id": "mk88",
        "name": "감자전",
        "emoji": "🥔",
        "description": "겉은 바삭, 속은 쫀득한 고소한 맛의 전",
        "ingredients": ["감자", "양파", "청양고추", "부침가루", "식용유"]
    },
    {
        "id": "mk89",
        "name": "오징어볶음",
        "emoji": "🦑",
        "description": "쫄깃한 오징어와 매콤한 양념이 어우러진 입맛 돋우는 요리",
        "ingredients": ["오징어", "양파", "대파", "고추", "고추장", "설탕", "다진 마늘"]
    },
    {
        "id": "mk90",
        "name": "비빔밥",
        "emoji": "🍚",
        "description": "다양한 나물과 고기를 고추장에 비벼 먹는 건강한 한 끼",
        "ingredients": ["밥", "시금치", "도라지", "고사리나물", "콩나물", "소고기", "계란", "참기름", "고추장"]
    },
    {
        "id": "mk91",
        "name": "잔치국수",
        "emoji": "🍜",
        "description": "따뜻한 멸치 육수에 말아낸 깔끔하고 든든한 국수",
        "ingredients": ["소면", "멸치", "다시마", "애호박", "당근", "계란", "김치", "국간장"]
    },
    {
        "id": "mk92",
        "name": "뼈해장국",
        "emoji": "🥣",
        "description": "푹 고아낸 등뼈와 구수한 시래기가 어우러진 얼큰한 해장국",
        "ingredients": ["돼지등뼈", "시래기", "감자", "들깨가루", "된장", "고추장", "다진 마늘", "생강"]
    },
    {
        "id": "mk93",
        "name": "떡볶이",
        "emoji": "🌶️",
        "description": "매콤달콤한 맛으로 모두의 사랑을 받는 국민 간식",
        "ingredients": ["가래떡", "어묵", "양파", "대파", "삶은 계란", "고추장", "설탕"]
    },
    {
        "id": "mk94",
        "name": "갈치구이",
