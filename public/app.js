...
        {"고유ID":4,"가게이름":"한양상회","가게분류":"농산물","main_product":"대파, 시금치, 양파, 쌈 채소(상추, 깻잎), (느타리, 새송이)","위치":"가-45/경동시장로","특징":"요리에 필수적인 기본 채소와 함께 다양한 쌈 채소를 판매합니다.","좌표":"873,310","url":"radiant-pony-a7da7a.netlify.app"},
...
        {"고유ID":10,"가게이름":"말구상회","가게분류":"농산물","main_product":"고구마, 고추, 상추, 호박, 감자, 대파, 표고버섯, 오이","위치":"가-51/경동시장로","특징":"찌개나 구이, 튀김에 쓰이는 감자와 고구마 등 필수 농산물을 취급합니다.","좌표":"873,548","url":"astonishing-meerkat-1deecd.netlify.app"},
...
        {"고유ID":29,"가게이름":"거북이젓갈","가게분류":"반찬/김치","main_product":"간장, 낙지젓, 새우젓, 오징어젓, 창난젓, 명란젓, 갈치속젓, 어리굴젓, 꼴뚜기젓","위치":"고산자로36번길/좌","특징":"밥반찬으로 좋은 다양한 젓갈을 전문으로 판매하며, 젓갈 종류가 다양합니다.","좌표":"232,470","url":"inspiring-queijadas-84fd9a.netlify.app"},
...
        {"고유ID":31,"가게이름":"진광젓갈","가게분류":"반찬/김치","main_product":"낙지젓, 간장, 새우젓, 오징어젓, 창난젓, 명란젓, 꼴뚜기젓, 젓갈류","위치":"고산자로36번길/좌","특징":"여러 종류의 젓갈을 취급합니다.","좌표":"301,470","url":"sage-concha-523f8f.netlify.app"},

        {"고유ID":32,"가게이름":"담가불라","가게분류":"반찬/김치","main_product":"낙지젓, 새우젓,간장, 설탕, 오징어젓, 창난젓, 명란젓, 어리굴젓, 갈치속젓","위치":"고산자로36번길/좌","특징":"직접 담근 젓갈을 판매하며, 특히 젓갈 종류가 매우 다양합니다.","좌표":"385,470","url":"elaborate-valkyrie-bddaf5.netlify.app"},
...
const mealKitData = [
    {
        ...
        "name": "된장찌개",
        "emoji": "🍲",
        "description": "구수한 맛이 일품인 한국인의 소울푸드",
        "ingredients": [
            { "name": "된장", "request": "" },
            { "name": "두부", "request": "찌개용" },
            { "name": "애호박", "request": "" },
    ...
    },
    {
        ...
        "name": "제육볶음",
        "emoji": "🍛",
        "description": "매콤달콤한 양념에 볶아낸 돼지고기 요리",
        "ingredients": [
            { "name": "앞다리살 300g", "request": "제육용" },
            { "name": "고추장 ", "request": "" },
            { "name": "양파", "request": "" },
            { "name": "대파", "request": "" },
            { "name": "깻잎", "request": "" },
    ...
    },
    {
        ...
        "name": "잡채",
        "emoji": "🍽️",
        "description": "잔칫날 빠질 수 없는 다채로운 색감의 면 요리",
        "ingredients": [
            { "name": "당면", "request": "" },
            { "name": "소고기", "request": "잡채용 채썰기" },
            { "name": "시금치", "request": "" },
            { "name": "당근", "request": "채썰기" },
            { "name": "양파", "request": "채썰기" },
            { "name": "표고버섯", "request": "채썰기" },
            { "name": "간장", "request": "" },
            { "name": "설탕", "request": "" },
            { "name": "참기름", "request": "" }
        ]
    },
    {
        ...
        "name": "해물파전",
        "emoji": "🦐",
        "description": "비 오는 날 생각나는 바삭하고 고소한 전",
        "ingredients": [
            { "name": "오징어", "request": "손질" },
            { "name": "새우", "request": "껍질 벗겨진 새우" },
            { "name": "쪽파", "request": "" },
            { "name": "부침가루", "request": "" },
            { "name": "계란", "request": "" },
            { "name": "식용유", "request": "" }
    ...
    },
    {
        ...
        "name": "소불고기",
        "emoji": "🥩",
        "description": "남녀노소 누구나 좋아하는 달콤짭짤한 소고기 요리",
        "ingredients": [
            { "name": "소고기", "request": "불고기용 다져진 고기" },
            { "name": "배", "request": "강판에 갈기" },
            { "name": "양파", "request": "채썰기" },
            { "name": "대파", "request": "어슷썰기" },
            { "name": "표고버섯 ", "request": "" },
            { "name": "간장", "request": "" },
            { "name": "설탕", "request": "" },
            { "name": "마늘", "request": "다져주세요" }
        ]
    },
    {
        "id": "mk85",
        "name": "닭볶음탕",
        "emoji": "🍗",
        "description": "매콤한 양념에 닭고기와 채소를 푹 끓여낸 밥도둑",
        "ingredients": [
            { "name": "닭", "request": "손질한 닭" },
            { "name": "감자", "request": "" },
            { "name": "당근", "request": "" },
            { "name": "양파", "request": "" },
            { "name": "대파", "request": "" },
    ...
    },
    {
        ...
        "name": "고등어조림",
        "emoji": "🐟",
        "description": "칼칼한 양념이 밴 부드러운 고등어와 달큰한 무의 조화",
        "ingredients": [
            { "name": "고등어", "request": "손질" },
            { "name": "무", "request": "큼직하게" },
            { "name": "대파", "request": "" },
    ...
    },
    {
        ...
        "name": "꽃게탕",
        "emoji": "🦀",
        "description": "시원하고 얼큰한 국물이 일품인 제철 꽃게 요리",
        "ingredients": [
            { "name": "꽃게", "request": "탕용 손질" },
            { "name": "무", "request": "" },
            { "name": "애호박", "request": "" },
            { "name": "대파", "request": "" },
            { "name": "쑥갓", "request": "" },
    ...
    },
    {
        ...
        "name": "갈치구이",
        "emoji": "🐟",
        "description": "담백하고 부드러운 살이 일품인 밥도둑 생선구이",
        "ingredients": [
            { "name": "갈치", "request": "손질" },
            { "name": "소금", "request": "" },
            { "name": "식용유", "request": "" },
    ...
    // 2. 전송할 주문 객체(newOrder) 생성
        const orderId = `CNY-${Date.now()}`;
        const newOrder = {
            orderId: orderId,
            userId: userId,
            cart: JSON.parse(JSON.stringify(shoppingCart)), // 장바구니 데이터 복사
            date: new Date().toISOString(), // 서버와 통신을 위한 표준 시간 형식
            totalPrice: Object.values(shoppingCart).reduce((sum, store) =>
                sum + Object.values(store.items).reduce((s, item) => s + item.price * item.quantity, 0), 0)
        };

    // 3. fetch를 이용해 서버로 주문 데이터 전송
        try {
            const response = await fetch('/api/order', {
                method: 'POST', // 데이터를 생성/전송하므로 POST 방식 사용
                headers: {
                    'Content-Type': 'application/json', // 우리가 보내는 데이터는 JSON 형식임을 명시
                },
                body: JSON.stringify(newOrder), // newOrder 객체를 JSON 문자열로 변환하여 전송
            });

            if (!response.ok) {
            // 서버가 200번대 응답을 주지 않으면 에러로 간주
                const errorData = await response.json().catch(() => ({ message: '서버 응답을 처리할 수 없습니다.' }));
                throw new Error(errorData.message || '서버에 주문을 등록하는 데 실패했습니다.');
            }

            const result = await response.json();
            console.log('서버로부터의 성공 응답:', result); // 성공 시 서버가 보낸 응답을 콘솔에 기록

        } catch (error) {
        // fetch 과정이나 서버에서 에러가 발생한 경우
            console.error('주문 전송 오류:', error);
            showMessage(`주문 처리 중 오류가 발생했습니다: ${error.message}`);
            return; // 오류가 발생했으므로 여기서 함수 실행을 중단
        }

    // 4. 서버 전송 성공 후, 기존 로직 실행 (알림, 장바구니 비우기 등)
        completedOrders.push(newOrder);

        for (const storeId in newOrder.cart) {
            const store = newOrder.cart[storeId];
            const firstItem = Object.values(store.items)[0];
            const totalItems = Object.keys(store.items).length;
            const message = `'${store.storeName}'에서 ${firstItem.name}` + (totalItems > 1 ? ` 외 ${totalItems - 1}건` : '') + ` 구매가 완료되었습니다.`;
            const newNotification = { id: Date.now() + parseInt(storeId), message: message, read: false };
        ...
        shoppingCart = {}; // 장바구니 비우기
        updateCartCountIndicator();

        const modal = document.querySelector('.modal-overlay');
        if (modal) modal.remove();
        showScreen('pickupScreen', { userId: userId }); // 다음 화면으로 전환
    }
    ...
    function renderMealKitList(searchTerm = '') {
        const container = document.getElementById('mealKitListContainer'); container.innerHTML = ''; const lowerCaseSearchTerm = searchTerm.toLowerCase().trim();
        const filteredKits = mealKitData.filter(kit => { if (!lowerCaseSearchTerm) return true; if (kit.name.toLowerCase().includes(lowerCaseSearchTerm)) return true; return kit.ingredients.some(ing => ing.name.toLowerCase().includes(lowerCaseSearchTerm)); });
        if (filteredKits.length === 0) { container.innerHTML = `<p class="text-center text-gray-500 py-10">검색 결과가 없습니다.</p>`; return; }
        filteredKits.forEach(kit => { const card = document.createElement('div'); card.className = 'meal-kit-item flex items-center bg-white p-4 rounded-lg border border-gray-200 cursor-pointer'; card.dataset.kitId = kit.id; const ingredientsPreview = kit.ingredients.slice(0, 3).map(ing => ing.name.split(' ')[0]).join(', ') + ' 등'; card.innerHTML = `<div class="w-20 h-20 rounded-md mr-4 bg-gray-100 flex items-center justify-center text-5xl">${kit.emoji}</div><div class="flex-1"><h3 class="font-bold text-lg text-gray-900">${kit.name}</h3><p class="text-sm text-gray-600 mt-1">${kit.description}</p><p class="text-xs text-gray-500 mt-2">${ingredientsPreview}</p></div><i class="ph ph-caret-right text-gray-400 text-2xl"></i>`; container.appendChild(card); });
    }
    function showMealKitDetailModal(kitId) {
        const kit = mealKitData.find(k => k.id === kitId); if (!kit) return;
        const modal = document.createElement('div'); modal.className = 'modal-overlay';
        const ingredientsHtml = kit.ingredients.map(ing => `<li class="flex justify-between py-2 border-b last:border-b-0"><span class="text-gray-800">${ing.name}</span>${ing.request ? `<span class="text-sm text-indigo-600 bg-indigo-50 px-2 rounded-full">${ing.request}</span>` : ''}</li>`).join('');
        modal.innerHTML = `<div class="modal-content"><div class="text-center mb-4"><span class="text-6xl">${kit.emoji}</span><h3 class="text-2xl font-bold mt-2">${kit.name}</h3><p class="text-gray-600 mt-1">${kit.description}</p></div><h4 class="font-semibold mb-2 text-gray-800">포함된 재료</h4><ul class="bg-gray-50 p-3 rounded-lg mb-6">${ingredientsHtml}</ul><div class="flex flex-col space-y-2"><button class="add-kit-to-recipe-btn w-full px-4 py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700" data-kit-id="${kit.id}">이 밀키트 레시피 담기</button><button onclick="this.closest('.modal-overlay').remove()" class="w-full px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-100">취소</button></div></div>`;
        document.getElementById('modalContainer').appendChild(modal);
    }
    function addMealKitToMyRecipes(kitId) {
        const kit = mealKitData.find(k => k.id === kitId); if (!kit) return;
        const newRecipe = { id: `recipe-${Date.now()}`, name: `[밀키트] ${kit.name}`, ingredients: [...kit.ingredients] };
        userRecipes.unshift(newRecipe); saveRecipesToStorage();
    ...
    function showScreen(screenId, param = null) {
        ...
        if (screenId === 'mapScreen') { appContainer.classList.remove('max-w-lg'); applyMarketMapUrl(getStoredMapUrl()); } else { appContainer.classList.add('max-w-lg'); }
